# Video Subtitle Project Instructions
...
- [ ] Compile the Project — blocked until npm registry access is restored and dependencies can be installed.
- [x] Create and Run Task — development task created; launch currently requires dependency installation.
- [ ] Launch the Project — pending dependency installation and user confirmation for debug mode.
